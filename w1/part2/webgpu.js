...
async function main() {
    ...
    var vertices = [];
    add_point(vertices, new Float32Array([0.0, 0.0]), point_size);
    add_point(vertices, new Float32Array([1, 0]), point_size);
    add_point(vertices, new Float32Array([1, 1]), point_size);
